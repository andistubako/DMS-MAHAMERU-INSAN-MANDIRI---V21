...
if (upsertSalesStockLedgerStart !== -1) {
  code = code.substring(0, upsertSalesStockLedgerStart);
  code += `  upsertSalesStockLedger: async (salesmanId: string, businessDate: string, skuId: string, updates: any, tx: any = sqlDb) => {
